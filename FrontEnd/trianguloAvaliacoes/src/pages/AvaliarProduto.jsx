...
return (
    <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', color: '#003B73' }} >
            ...
            <input placeholder="Qual nota você daria para este produto?" style={{ width: 400, borderRadius: 8, border: '1px solid #0057A8', padding: 8, backgroundColor: '#f4f7fb', color: '#003B73' }} value={nota} onChange={(e) => setNota(e.target.value)} />
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', color: '#003B73' }} >
